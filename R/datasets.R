...
#' [,5] \tab CRUISE_NO \tab numeric \tab insert_description_here\cr
...
#' [,19] \tab MIN_FISH \tab integer \tab insert_description_here\cr
...
#' [,5] \tab CATCHSEX \tab integer \tab insert_description_here\cr
...
#' [,19] \tab LENGTH \tab numeric \tab insert_description_here\cr
#' [,20] \tab NUMLEN \tab integer \tab insert_description_here\cr
...
#' [,3] \tab vessel \tab integer \tab species scientific name; Genus species\cr
...
#' [,10] \tab stratum \tab character \tab the common name of the organism sampled\cr
...
#' [,15] \tab windforce \tab numeric \tab insert_description_here\cr
...
#' [,38] \tab common \tab character \tab duration of the haul (how long the net was being towed)\cr
#' [,39] \tab spp \tab character \tab the maximum depth of the water at the location of the haul\cr
...
#' [,19] \tab EFFORT \tab numeric \tab insert_description_here\cr
...
#' [,24] \tab DURATION \tab integer \tab insert_description_here\cr
...
#' [,34] \tab SALINITYSURFACE \tab numeric \tab insert_description_here\cr
#' [,35] \tab SALINITYBOTTOM \tab numeric \tab insert_description_here\cr
#' [,36] \tab SDO \tab logical \tab insert_description_here\cr
#' [,37] \tab BDO \tab logical \tab insert_description_here\cr
#' [,38] \tab TEMPAIR \tab numeric \tab insert_description_here\cr
...
#' [,50] \tab WINDSPEED \tab integer \tab insert_description_here\cr
...
#' \tabular{rlll}{
#' [,1] \tab stratum \tab integer \tab year of haul\cr
#' [,2] \tab vessel \tab character \tab starting time of the tow\cr
#' [,3] \tab cruise \tab integer \tab the species name of the species\cr
#' [,4] \tab set \tab integer \tab insert_description_here\cr
#' [,5] \tab year \tab integer \tab vessel ID\cr
#' [,6] \tab species \tab integer \tab cruise ID\cr
...
#' [,12] \tab time \tab integer \tab the statistical stratum of the haul\cr
...
#' [,25] \tab salin_bottom \tab numeric \tab insert_description_here\cr
...
#' [,2] \tab stratum \tab character \tab species scientific name; Genus species\cr
...
#' [,19] \tab DUR \tab integer \tab insert_description_here\cr
...
#' [,26] \tab WIND \tab integer \tab insert_description_here\cr
...
#' [,38] \tab BOTTOM_SALINITY \tab numeric \tab insert_description_here\cr
...
#' [,41] \tab spp \tab character \tab the common name of the organism sampled\cr
#' [,42] \tab common \tab character \tab the statistical stratum of the haul\cr
#' }
"raw.shelf"
...
#' [,17] \tab Trawl Duration (min) \tab numeric \tab insert_description_here\cr
...
#' [,17] \tab DURATION \tab numeric \tab insert_description_here\cr
...
#' \tabular{rlll}{
#' [,1] \tab ref \tab character \tab survey region\cr
#' [,2] \tab stratum \tab character \tab year of haul\cr
#' [,3] \tab lat \tab numeric \tab the day and time of the haul\cr
#' [,4] \tab lon \tab numeric \tab reference taxonomic ID from raw data\cr
#' [,5] \tab station \tab character \tab species scientific name; Genus species\cr
#' [,6] \tab year \tab character \tab the common name of the organism sampled\cr
#' [,7] \tab datetime \tab c("POSIXct", "POSIXt") \tab the genus of the species\cr
#' [,8] \tab wtcpue \tab numeric \tab the species name of the species\cr
#' [,9] \tab cntcpue \tab numeric \tab species identification number\cr
#' [,10] \tab SID \tab integer \tab vessel ID\cr
#' [,11] \tab depth \tab numeric \tab cruise ID\cr
#' [,12] \tab btemp \tab numeric \tab the integer haul number within a cruise\cr
#' [,13] \tab stemp \tab numeric \tab a unique identifier for the haul; vessel ID - cruise ID - haul number\cr
#' [,14] \tab vessel \tab character \tab the statistical stratum of the haul\cr
#' [,15] \tab cruise \tab character \tab the station ID for the haul\cr
#' [,16] \tab haul \tab character \tab the area of the statistical stratum (km2)\cr
#' [,17] \tab stratumarea \tab numeric \tab latitude of the haul\cr
#' [,18] \tab haulid \tab character \tab longitude of the haul, in western hemisphere degrees (for lon > 0, do lon-360)\cr
#' [,19] \tab season \tab character \tab insert_description_here\cr
#' [,20] \tab reg \tab character \tab the maximum depth of the water at the location of the haul\cr
#' [,21] \tab val.src \tab character \tab insert_description_here\cr
#' [,22] \tab tbl.row \tab integer \tab insert_description_here\cr
#' [,23] \tab mtch.src \tab integer \tab insert_description_here\cr
#' [,24] \tab tax.src \tab character \tab insert_description_here\cr
#' [,25] \tab spp \tab character \tab water temperature at the surface at the location of the haul\cr
#' [,26] \tab common \tab character \tab water temperature at the bottom at the location of the haul\cr
#' [,27] \tab taxLvl \tab character \tab insert_description_here\cr
#' [,28] \tab species \tab character \tab weight (mass) of the catch\cr
#' [,29] \tab genus \tab character \tab number of individuals caught per hectare in the haul\cr
#' [,30] \tab family \tab character \tab insert_description_here\cr
#' [,31] \tab order \tab character \tab insert_description_here\cr
#' [,32] \tab class \tab character \tab insert_description_here\cr
#' [,33] \tab superclass \tab character \tab insert_description_here\cr
#' [,34] \tab subphylum \tab character \tab insert_description_here\cr
#' [,35] \tab phylum \tab character \tab insert_description_here\cr
#' [,36] \tab kingdom \tab character \tab insert_description_here\cr
#' [,37] \tab trophicDiet \tab character \tab insert_description_here\cr
#' [,38] \tab trophicOrig \tab character \tab insert_description_here\cr
#' [,39] \tab Picture \tab character \tab insert_description_here\cr
#' [,40] \tab trophicLevel \tab numeric \tab insert_description_here\cr
#' [,41] \tab trophicLevel.se \tab numeric \tab insert_description_here\cr
#' [,42] \tab tax.src2 \tab character \tab insert_description_here\cr
#' [,43] \tab conflict \tab logical \tab insert_description_here\cr
#' [,44] \tab flag \tab character \tab insert_description_here\cr
#' [,45] \tab website \tab character \tab insert_description_here\cr
#' [,46] \tab website2 \tab character \tab insert_description_here\cr
#' [,47] \tab keep.row \tab logical \tab insert_description_here\cr
#' }
"clean.ai"
...
#' \tabular{rlll}{
#' [,1] \tab ref \tab character \tab survey region\cr
#' [,2] \tab cruise \tab character \tab year of haul\cr
#' [,3] \tab vessel \tab character \tab the day and time of the haul\cr
#' [,4] \tab SID \tab character \tab time zone\cr
#' [,5] \tab station \tab character \tab starting time of the tow\cr
#' [,6] \tab CRUISE_NO \tab numeric \tab insert_description_here\cr
#' [,7] \tab P_STA_NO \tab numeric \tab insert_description_here\cr
#' [,8] \tab BGSID \tab integer \tab date of the tow\cr
#' [,9] \tab unknown \tab integer \tab insert_description_here\cr
#' [,10] \tab BGSCODE \tab character \tab reference taxonomic ID from raw data\cr
#' [,11] \tab cnt \tab numeric \tab species scientific name; Genus species\cr
#' [,12] \tab weight \tab numeric \tab the common name of the organism sampled\cr
#' [,13] \tab towID \tab character \tab insert_description_here\cr
#' [,14] \tab gearsize \tab integer \tab the genus of the species\cr
#' [,15] \tab geartype \tab character \tab the species name of the species\cr
#' [,16] \tab meshsize \tab numeric \tab record ID number\cr
#' [,17] \tab OP \tab character \tab insert_description_here\cr
#' [,18] \tab towduration \tab numeric \tab insert_description_here\cr
#' [,19] \tab timezone \tab character \tab species identification number\cr
#' [,20] \tab time \tab character \tab vessel ID\cr
...
#' [,25] \tab depth \tab numeric \tab cruise ID\cr
#' [,26] \tab date \tab character \tab a unique identifier for the haul; vessel ID - cruise ID - haul number\cr
...
#' [,31] \tab stemp \tab numeric \tab the statistical stratum of the haul\cr
#' [,32] \tab btemp \tab numeric \tab the station ID for the haul\cr
#' [,33] \tab towspeed \tab numeric \tab flags information about the biological sample\cr
...
#' [,36] \tab haulid \tab character \tab the dimension of the gear; for trawl net, the width of the mouth in ft\cr
#' [,37] \tab datetime \tab c("POSIXct", "POSIXt") \tab code for the type of gear used\cr
#' [,38] \tab year \tab character \tab the size of the net mesh (inches of stretch)\cr
#' [,39] \tab lat \tab numeric \tab the speed of the vessel\cr
#' [,40] \tab lon \tab numeric \tab the area of the statistical stratum (km2)\cr
#' [,41] \tab stratum \tab character \tab latitude of the haul\cr
#' [,42] \tab stratumarea \tab numeric \tab longitude of the haul, in western hemisphere degrees (for lon > 0, do lon-360)\cr
#' [,43] \tab towarea \tab numeric \tab insert_description_here\cr
#' [,44] \tab effort \tab numeric \tab insert_description_here\cr
#' [,45] \tab wtcpue \tab numeric \tab the maximum depth of the water at the location of the haul\cr
#' [,46] \tab cntcpue \tab numeric \tab water temperature at the surface at the location of the haul\cr
#' [,47] \tab reg \tab character \tab water temperature at the bottom at the location of the haul\cr
#' [,48] \tab val.src \tab character \tab insert_description_here\cr
#' [,49] \tab tbl.row \tab integer \tab insert_description_here\cr
#' [,50] \tab mtch.src \tab integer \tab insert_description_here\cr
#' [,51] \tab tax.src \tab character \tab insert_description_here\cr
#' [,52] \tab spp \tab character \tab weight (mass) of the catch\cr
#' [,53] \tab common \tab character \tab number of individuals caught per hectare in the haul\cr
#' [,54] \tab taxLvl \tab character \tab insert_description_here\cr
#' [,55] \tab species \tab character \tab number of individuals in the whole net (may be extrapolated)\cr
#' [,56] \tab genus \tab character \tab the weight (mass) of all items in the net (may be extrapolated)\cr
#' [,57] \tab family \tab character \tab insert_description_here\cr
#' [,58] \tab order \tab character \tab insert_description_here\cr
#' [,59] \tab class \tab character \tab insert_description_here\cr
#' [,60] \tab superclass \tab character \tab insert_description_here\cr
#' [,61] \tab subphylum \tab character \tab insert_description_here\cr
#' [,62] \tab phylum \tab character \tab insert_description_here\cr
#' [,63] \tab kingdom \tab character \tab insert_description_here\cr
#' [,64] \tab trophicDiet \tab character \tab insert_description_here\cr
#' [,65] \tab trophicOrig \tab character \tab insert_description_here\cr
#' [,66] \tab Picture \tab character \tab insert_description_here\cr
#' [,67] \tab trophicLevel \tab numeric \tab insert_description_here\cr
#' [,68] \tab trophicLevel.se \tab numeric \tab insert_description_here\cr
#' [,69] \tab tax.src2 \tab character \tab insert_description_here\cr
#' [,70] \tab conflict \tab logical \tab insert_description_here\cr
#' [,71] \tab flag \tab character \tab insert_description_here\cr
#' [,72] \tab website \tab character \tab insert_description_here\cr
#' [,73] \tab website2 \tab character \tab insert_description_here\cr
#' [,74] \tab keep.row \tab logical \tab insert_description_here\cr
#' }
"clean.gmex"
...
#' [,8] \tab wtcpue \tab numeric \tab the species name of the species\cr
#' [,9] \tab cntcpue \tab numeric \tab species identification number\cr
#' [,10] \tab SID \tab character \tab vessel ID\cr
#' [,11] \tab depth \tab numeric \tab cruise ID\cr
#' [,12] \tab btemp \tab numeric \tab the integer haul number within a cruise\cr
#' [,13] \tab stemp \tab numeric \tab a unique identifier for the haul; vessel ID - cruise ID - haul number\cr
#' [,14] \tab vessel \tab character \tab the statistical stratum of the haul\cr
...
#' [,1] \tab ref \tab character \tab survey region\cr
#' [,2] \tab cruise \tab character \tab year of haul\cr
#' [,3] \tab station \tab character \tab the day and time of the haul\cr
#' [,4] \tab stratum \tab character \tab reference taxonomic ID from raw data\cr
#' [,5] \tab SID \tab integer \tab species scientific name; Genus species\cr
#' [,6] \tab sex \tab integer \tab insert_description_here\cr
#' [,7] \tab vessel \tab character \tab the common name of the organism sampled\cr
#' [,8] \tab year \tab character \tab the genus of the species\cr
#' [,9] \tab season \tab character \tab insert_description_here\cr
#' [,10] \tab lat \tab numeric \tab the species name of the species\cr
#' [,11] \tab lon \tab numeric \tab species identification number\cr
#' [,12] \tab datetime \tab c("POSIXct", "POSIXt") \tab vessel ID\cr
#' [,13] \tab depth \tab numeric \tab cruise ID\cr
#' [,14] \tab stemp \tab numeric \tab a unique identifier for the haul; vessel ID - cruise ID - haul number\cr
#' [,15] \tab ssalin \tab numeric \tab insert_description_here\cr
#' [,16] \tab btemp \tab numeric \tab the statistical stratum of the haul\cr
#' [,17] \tab bsalin \tab numeric \tab insert_description_here\cr
#' [,18] \tab cnt \tab numeric \tab the station ID for the haul\cr
#' [,19] \tab weight \tab numeric \tab the area of the statistical stratum (km2)\cr
#' [,20] \tab length \tab numeric \tab insert_description_here\cr
#' [,21] \tab NUMLEN \tab integer \tab insert_description_here\cr
#' [,22] \tab ITISSPP \tab integer \tab insert_description_here\cr
#' [,23] \tab AUTHOR \tab character \tab insert_description_here\cr
#' [,24] \tab stratumarea \tab numeric \tab latitude of the haul\cr
#' [,25] \tab haulid \tab character \tab longitude of the haul, in western hemisphere degrees (for lon > 0, do lon-360)\cr
#' [,26] \tab cntcpue \tab numeric \tab the maximum depth of the water at the location of the haul\cr
#' [,27] \tab wtcpue \tab numeric \tab water temperature at the surface at the location of the haul\cr
#' [,28] \tab reg \tab character \tab water temperature at the bottom at the location of the haul\cr
#' [,29] \tab val.src \tab character \tab insert_description_here\cr
#' [,30] \tab tbl.row \tab integer \tab insert_description_here\cr
#' [,31] \tab mtch.src \tab integer \tab insert_description_here\cr
#' [,32] \tab tax.src \tab character \tab insert_description_here\cr
#' [,33] \tab spp \tab character \tab weight (mass) of the catch\cr
#' [,34] \tab common \tab character \tab number of individuals caught per hectare in the haul\cr
#' [,35] \tab taxLvl \tab character \tab insert_description_here\cr
#' [,36] \tab species \tab character \tab number of individuals in the whole net (may be extrapolated)\cr
#' [,37] \tab genus \tab character \tab the weight (mass) of all items in the net (may be extrapolated)\cr
#' [,38] \tab family \tab character \tab insert_description_here\cr
#' [,39] \tab order \tab character \tab insert_description_here\cr
#' [,40] \tab class \tab character \tab insert_description_here\cr
#' [,41] \tab superclass \tab character \tab insert_description_here\cr
#' [,42] \tab subphylum \tab character \tab insert_description_here\cr
#' [,43] \tab phylum \tab character \tab insert_description_here\cr
#' [,44] \tab kingdom \tab character \tab insert_description_here\cr
#' [,45] \tab trophicDiet \tab character \tab insert_description_here\cr
#' [,46] \tab trophicOrig \tab character \tab insert_description_here\cr
#' [,47] \tab Picture \tab character \tab insert_description_here\cr
#' [,48] \tab trophicLevel \tab numeric \tab insert_description_here\cr
#' [,49] \tab trophicLevel.se \tab numeric \tab insert_description_here\cr
#' [,50] \tab tax.src2 \tab character \tab insert_description_here\cr
#' [,51] \tab conflict \tab logical \tab insert_description_here\cr
#' [,52] \tab flag \tab character \tab insert_description_here\cr
#' [,53] \tab website \tab character \tab insert_description_here\cr
#' [,54] \tab website2 \tab character \tab insert_description_here\cr
#' [,55] \tab keep.row \tab logical \tab insert_description_here\cr
#' }
"clean.neus"
...
#' [,11] \tab stratum \tab character \tab starting time of the tow\cr
...
#' [,16] \tab wind \tab numeric \tab insert_description_here\cr
#' [,17] \tab sea \tab numeric \tab insert_description_here\cr
#' [,18] \tab bottom \tab numeric \tab insert_description_here\cr
#' [,19] \tab time \tab character \tab reference taxonomic ID from raw data\cr
#' [,20] \tab towduration \tab numeric \tab insert_description_here\cr
#' [,21] \tab towdistance \tab numeric \tab insert_description_here\cr
#' [,22] \tab operation \tab numeric \tab insert_description_here\cr
#' [,23] \tab depth \tab numeric \tab species scientific name; Genus species\cr
...
#' [,27] \tab stemp \tab numeric \tab the common name of the organism sampled\cr
#' [,28] \tab btemp \tab numeric \tab the genus of the species\cr
...
#' [,32] \tab geartype \tab character \tab the species name of the species\cr
#' [,33] \tab cnt \tab numeric \tab vessel ID\cr
#' [,34] \tab weight \tab numeric \tab a unique identifier for the haul; vessel ID - cruise ID - haul number\cr
...
#' [,40] \tab haulid \tab character \tab the statistical stratum of the haul\cr
#' [,41] \tab datetime \tab c("POSIXct", "POSIXt") \tab code for the type of gear used\cr
...
#' [,45] \tab effort \tab numeric \tab insert_description_here\cr
#' [,46] \tab wtcpue \tab numeric \tab the maximum depth of the water at the location of the haul\cr
#' [,47] \tab cntcpue \tab numeric \tab water temperature at the surface at the location of the haul\cr
#' [,48] \tab reg \tab character \tab water temperature at the bottom at the location of the haul\cr
#' [,49] \tab val.src \tab character \tab insert_description_here\cr
#' [,50] \tab tbl.row \tab integer \tab insert_description_here\cr
#' [,51] \tab mtch.src \tab integer \tab insert_description_here\cr
#' [,52] \tab tax.src \tab character \tab insert_description_here\cr
#' [,53] \tab spp \tab character \tab weight (mass) of the catch\cr
#' [,54] \tab common \tab character \tab number of individuals caught per hectare in the haul\cr
#' [,55] \tab taxLvl \tab character \tab insert_description_here\cr
#' [,56] \tab species \tab character \tab number of individuals in the whole net (may be extrapolated)\cr
#' [,57] \tab genus \tab character \tab the weight (mass) of all items in the net (may be extrapolated)\cr
#' [,58] \tab family \tab character \tab insert_description_here\cr
#' [,59] \tab order \tab character \tab insert_description_here\cr
#' [,60] \tab class \tab character \tab insert_description_here\cr
#' [,61] \tab superclass \tab character \tab insert_description_here\cr
#' [,62] \tab subphylum \tab character \tab insert_description_here\cr
#' [,63] \tab phylum \tab character \tab insert_description_here\cr
#' [,64] \tab kingdom \tab character \tab insert_description_here\cr
#' [,65] \tab trophicDiet \tab character \tab insert_description_here\cr
#' [,66] \tab trophicOrig \tab character \tab insert_description_here\cr
#' [,67] \tab Picture \tab character \tab insert_description_here\cr
#' [,68] \tab trophicLevel \tab numeric \tab insert_description_here\cr
#' [,69] \tab trophicLevel.se \tab numeric \tab insert_description_here\cr
#' [,70] \tab tax.src2 \tab character \tab insert_description_here\cr
#' [,71] \tab conflict \tab logical \tab insert_description_here\cr
#' [,72] \tab flag \tab character \tab insert_description_here\cr
#' [,73] \tab website \tab character \tab insert_description_here\cr
#' [,74] \tab website2 \tab character \tab insert_description_here\cr
#' [,75] \tab keep.row \tab logical \tab insert_description_here\cr
#' }
"clean.newf"
...
#' [,5] \tab date \tab character \tab year of haul\cr
#' [,6] \tab haulid \tab character \tab the day and time of the haul\cr
#' [,7] \tab vessel \tab character \tab time zone\cr
...
#' [,12] \tab cnt \tab numeric \tab starting time of the tow\cr
#' [,13] \tab weight \tab numeric \tab date of the tow\cr
...
#' [,18] \tab effort \tab numeric \tab insert_description_here\cr
...
#' [,22] \tab time \tab character \tab reference taxonomic ID from raw data\cr
#' [,23] \tab towduration \tab numeric \tab insert_description_here\cr
...
#' [,29] \tab stratum \tab character \tab species scientific name; Genus species\cr
#' [,30] \tab EVENTTYPEDESCRIPTION \tab character \tab insert_description_here\cr
#' [,31] \tab stemp \tab numeric \tab the common name of the organism sampled\cr
#' [,32] \tab btemp \tab numeric \tab the genus of the species\cr
#' [,33] \tab ssalin \tab numeric \tab insert_description_here\cr
#' [,34] \tab bsalin \tab numeric \tab insert_description_here\cr
#' [,35] \tab sdo \tab logical \tab insert_description_here\cr
#' [,36] \tab bdo \tab numeric \tab insert_description_here\cr
#' [,37] \tab airtemp \tab numeric \tab insert_description_here\cr
...
#' [,45] \tab timezone \tab character \tab the species name of the species\cr
...
#' [,49] \tab wind \tab integer \tab insert_description_here\cr
...
#' [,62] \tab year \tab integer \tab vessel ID\cr
#' [,63] \tab datetime \tab c("POSIXct", "POSIXt") \tab a unique identifier for the haul; vessel ID - cruise ID - haul number\cr
#' [,64] \tab lat \tab numeric \tab the statistical stratum of the haul\cr
#' [,65] \tab lon \tab numeric \tab the area of the statistical stratum (km2)\cr
#' [,66] \tab depth \tab numeric \tab latitude of the haul\cr
#' [,67] \tab stratumarea \tab numeric \tab longitude of the haul, in western hemisphere degrees (for lon > 0, do lon-360)\cr
#' [,68] \tab cntcpue \tab numeric \tab the maximum depth of the water at the location of the haul\cr
#' [,69] \tab wtcpue \tab numeric \tab water temperature at the surface at the location of the haul\cr
#' [,70] \tab reg \tab character \tab water temperature at the bottom at the location of the haul\cr
#' [,71] \tab val.src \tab character \tab insert_description_here\cr
#' [,72] \tab tbl.row \tab integer \tab insert_description_here\cr
#' [,73] \tab mtch.src \tab integer \tab insert_description_here\cr
#' [,74] \tab tax.src \tab character \tab insert_description_here\cr
#' [,75] \tab spp \tab character \tab weight (mass) of the catch\cr
#' [,76] \tab common \tab character \tab number of individuals caught per hectare in the haul\cr
#' [,77] \tab taxLvl \tab character \tab insert_description_here\cr
#' [,78] \tab species \tab character \tab number of individuals in the whole net (may be extrapolated)\cr
#' [,79] \tab genus \tab character \tab the weight (mass) of all items in the net (may be extrapolated)\cr
#' [,80] \tab family \tab character \tab insert_description_here\cr
#' [,81] \tab order \tab character \tab insert_description_here\cr
#' [,82] \tab class \tab character \tab insert_description_here\cr
#' [,83] \tab superclass \tab character \tab insert_description_here\cr
#' [,84] \tab subphylum \tab character \tab insert_description_here\cr
#' [,85] \tab phylum \tab character \tab insert_description_here\cr
#' [,86] \tab kingdom \tab character \tab insert_description_here\cr
#' [,87] \tab trophicDiet \tab character \tab insert_description_here\cr
#' [,88] \tab trophicOrig \tab character \tab insert_description_here\cr
#' [,89] \tab Picture \tab character \tab insert_description_here\cr
#' [,90] \tab trophicLevel \tab numeric \tab insert_description_here\cr
#' [,91] \tab trophicLevel.se \tab numeric \tab insert_description_here\cr
#' [,92] \tab tax.src2 \tab character \tab insert_description_here\cr
#' [,93] \tab conflict \tab logical \tab insert_description_here\cr
#' [,94] \tab flag \tab character \tab insert_description_here\cr
#' [,95] \tab website \tab character \tab insert_description_here\cr
#' [,96] \tab website2 \tab character \tab insert_description_here\cr
#' [,97] \tab keep.row \tab logical \tab insert_description_here\cr
#' }
"clean.sa"
...
#' [,2] \tab stratum \tab character \tab year of haul\cr
#' [,3] \tab vessel \tab character \tab the day and time of the haul\cr
#' [,4] \tab cruise \tab character \tab starting time of the tow\cr
#' [,5] \tab set \tab character \tab insert_description_here\cr
#' [,6] \tab year \tab character \tab reference taxonomic ID from raw data\cr
#' [,7] \tab species.code \tab integer \tab insert_description_here\cr
#' [,8] \tab cntcpue \tab numeric \tab species scientific name; Genus species\cr
#' [,9] \tab wtcpue \tab numeric \tab the common name of the organism sampled\cr
...
#' [,13] \tab time \tab character \tab the genus of the species\cr
...
#' [,18] \tab depth \tab numeric \tab the species name of the species\cr
#' [,19] \tab lat \tab numeric \tab vessel ID\cr
#' [,20] \tab lon \tab numeric \tab cruise ID\cr
#' [,21] \tab cnt \tab numeric \tab a unique identifier for the haul; vessel ID - cruise ID - haul number\cr
#' [,22] \tab weight \tab numeric \tab the statistical stratum of the haul\cr
#' [,23] \tab stemp \tab numeric \tab the area of the statistical stratum (km2)\cr
#' [,24] \tab bsalin \tab numeric \tab insert_description_here\cr
#' [,25] \tab btemp \tab numeric \tab latitude of the haul\cr
#' [,26] \tab trawlableunits \tab integer \tab insert_description_here\cr
#' [,27] \tab stratumarea \tab numeric \tab longitude of the haul, in western hemisphere degrees (for lon > 0, do lon-360)\cr
#' [,28] \tab haulid \tab character \tab the maximum depth of the water at the location of the haul\cr
#' [,29] \tab datetime \tab c("POSIXct", "POSIXt") \tab water temperature at the surface at the location of the haul\cr
#' [,30] \tab season \tab character \tab insert_description_here\cr
#' [,31] \tab reg \tab character \tab water temperature at the bottom at the location of the haul\cr
#' [,32] \tab val.src \tab character \tab insert_description_here\cr
#' [,33] \tab tbl.row \tab integer \tab insert_description_here\cr
#' [,34] \tab mtch.src \tab integer \tab insert_description_here\cr
#' [,35] \tab tax.src \tab character \tab insert_description_here\cr
#' [,36] \tab spp \tab character \tab weight (mass) of the catch\cr
#' [,37] \tab common \tab character \tab number of individuals caught per hectare in the haul\cr
#' [,38] \tab taxLvl \tab character \tab insert_description_here\cr
#' [,39] \tab species \tab character \tab number of individuals in the whole net (may be extrapolated)\cr
#' [,40] \tab genus \tab character \tab the weight (mass) of all items in the net (may be extrapolated)\cr
#' [,41] \tab family \tab character \tab insert_description_here\cr
#' [,42] \tab order \tab character \tab insert_description_here\cr
#' [,43] \tab class \tab character \tab insert_description_here\cr
#' [,44] \tab superclass \tab character \tab insert_description_here\cr
#' [,45] \tab subphylum \tab character \tab insert_description_here\cr
#' [,46] \tab phylum \tab character \tab insert_description_here\cr
#' [,47] \tab kingdom \tab character \tab insert_description_here\cr
#' [,48] \tab trophicDiet \tab character \tab insert_description_here\cr
#' [,49] \tab trophicOrig \tab character \tab insert_description_here\cr
#' [,50] \tab Picture \tab character \tab insert_description_here\cr
#' [,51] \tab trophicLevel \tab numeric \tab insert_description_here\cr
#' [,52] \tab trophicLevel.se \tab numeric \tab insert_description_here\cr
#' [,53] \tab tax.src2 \tab character \tab insert_description_here\cr
#' [,54] \tab conflict \tab logical \tab insert_description_here\cr
#' [,55] \tab flag \tab character \tab insert_description_here\cr
#' [,56] \tab website \tab character \tab insert_description_here\cr
#' [,57] \tab website2 \tab character \tab insert_description_here\cr
#' [,58] \tab keep.row \tab logical \tab insert_description_here\cr
#' }
"clean.sgulf"
...
#' [,3] \tab stratum \tab character \tab year of haul\cr
...
#' [,8] \tab wtcpue \tab numeric \tab the day and time of the haul\cr
#' [,9] \tab cntcpue \tab numeric \tab starting time of the tow\cr
...
#' [,14] \tab time \tab character \tab reference taxonomic ID from raw data\cr
...
#' [,23] \tab towspeed \tab numeric \tab species scientific name; Genus species\cr
...
#' [,27] \tab wind \tab integer \tab insert_description_here\cr
...
#' [,33] \tab depth \tab numeric \tab the common name of the organism sampled\cr
...
#' [,37] \tab stemp \tab numeric \tab the genus of the species\cr
#' [,38] \tab btemp \tab numeric \tab the species name of the species\cr
#' [,39] \tab bsalin \tab numeric \tab insert_description_here\cr
#' [,40] \tab depthzone_fathoms \tab character \tab insert_description_here\cr
#' [,41] \tab stratumarea \tab numeric \tab a unique identifier for the haul; vessel ID - cruise ID - haul number\cr
#' [,42] \tab haulid \tab character \tab the statistical stratum of the haul\cr
#' [,43] \tab datetime \tab c("POSIXct", "POSIXt") \tab the speed of the vessel\cr
#' [,44] \tab year \tab numeric \tab the area of the statistical stratum (km2)\cr
...
#' [,48] \tab reg \tab character \tab the maximum depth of the water at the location of the haul\cr
#' [,49] \tab val.src \tab character \tab insert_description_here\cr
#' [,50] \tab tbl.row \tab integer \tab insert_description_here\cr
#' [,51] \tab mtch.src \tab integer \tab insert_description_here\cr
#' [,52] \tab tax.src \tab character \tab insert_description_here\cr
#' [,53] \tab spp \tab character \tab water temperature at the surface at the location of the haul\cr
#' [,54] \tab common \tab character \tab water temperature at the bottom at the location of the haul\cr
#' [,55] \tab taxLvl \tab character \tab insert_description_here\cr
#' [,56] \tab species \tab character \tab weight (mass) of the catch\cr
#' [,57] \tab genus \tab character \tab number of individuals caught per hectare in the haul\cr
#' [,58] \tab family \tab character \tab insert_description_here\cr
#' [,59] \tab order \tab character \tab insert_description_here\cr
#' [,60] \tab class \tab character \tab insert_description_here\cr
#' [,61] \tab superclass \tab character \tab insert_description_here\cr
...
#' \tabular{rlll}{
#' [,1] \tab ref \tab character \tab survey region\cr
#' [,2] \tab haulid \tab character \tab year of haul\cr
#' [,3] \tab weight \tab numeric \tab the day and time of the haul\cr
#' [,4] \tab Individual.Average.Weight..kg. \tab numeric \tab insert_description_here\cr
#' [,5] \tab Survey \tab character \tab insert_description_here\cr
#' [,6] \tab year \tab character \tab date of the tow\cr
#' [,7] \tab vessel \tab character \tab reference taxonomic ID from raw data\cr
#' [,8] \tab Cruise.Leg \tab integer \tab insert_description_here\cr
#' [,9] \tab Trawl.Performance \tab character \tab insert_description_here\cr
#' [,10] \tab date \tab character \tab species scientific name; Genus species\cr
#' [,11] \tab datetime \tab c("POSIXct", "POSIXt") \tab the common name of the organism sampled\cr
#' [,12] \tab lat \tab numeric \tab the genus of the species\cr
#' [,13] \tab lon \tab numeric \tab the species name of the species\cr
#' [,14] \tab Best.Position.Type \tab character \tab insert_description_here\cr
#' [,15] \tab depth \tab numeric \tab vessel ID\cr
#' [,16] \tab Best.Depth.Type \tab character \tab insert_description_here\cr
#' [,17] \tab towduration \tab numeric \tab insert_description_here\cr
#' [,18] \tab towarea \tab numeric \tab insert_description_here\cr
#' [,19] \tab btemp \tab numeric \tab a unique identifier for the haul; vessel ID - cruise ID - haul number\cr
...
#' [,22] \tab effort \tab numeric \tab insert_description_here\cr
#' [,23] \tab wtcpue \tab numeric \tab latitude of the haul\cr
#' [,24] \tab cnt \tab numeric \tab longitude of the haul, in western hemisphere degrees (for lon > 0, do lon-360)\cr
#' [,25] \tab cntcpue \tab numeric \tab the maximum depth of the water at the location of the haul\cr
#' [,26] \tab reg \tab character \tab water temperature at the bottom at the location of the haul\cr
#' [,27] \tab val.src \tab character \tab insert_description_here\cr
#' [,28] \tab tbl.row \tab integer \tab insert_description_here\cr
#' [,29] \tab mtch.src \tab integer \tab insert_description_here\cr
#' [,30] \tab tax.src \tab character \tab insert_description_here\cr
#' [,31] \tab spp \tab character \tab weight (mass) of the catch\cr
#' [,32] \tab common \tab character \tab number of individuals caught per hectare in the haul\cr
#' [,33] \tab taxLvl \tab character \tab insert_description_here\cr
#' [,34] \tab species \tab character \tab number of individuals in the whole net (may be extrapolated)\cr
#' [,35] \tab genus \tab character \tab the weight (mass) of all items in the net (may be extrapolated)\cr
#' [,36] \tab family \tab character \tab insert_description_here\cr
#' [,37] \tab order \tab character \tab insert_description_here\cr
#' [,38] \tab class \tab character \tab insert_description_here\cr
#' [,39] \tab superclass \tab character \tab insert_description_here\cr
#' [,40] \tab subphylum \tab character \tab insert_description_here\cr
#' [,41] \tab phylum \tab character \tab insert_description_here\cr
#' [,42] \tab kingdom \tab character \tab insert_description_here\cr
#' [,43] \tab trophicDiet \tab character \tab insert_description_here\cr
#' [,44] \tab trophicOrig \tab character \tab insert_description_here\cr
#' [,45] \tab Picture \tab character \tab insert_description_here\cr
#' [,46] \tab trophicLevel \tab numeric \tab insert_description_here\cr
#' [,47] \tab trophicLevel.se \tab numeric \tab insert_description_here\cr
#' [,48] \tab tax.src2 \tab character \tab insert_description_here\cr
#' [,49] \tab conflict \tab logical \tab insert_description_here\cr
#' [,50] \tab flag \tab character \tab insert_description_here\cr
#' [,51] \tab website \tab character \tab insert_description_here\cr
#' [,52] \tab website2 \tab character \tab insert_description_here\cr
#' [,53] \tab keep.row \tab logical \tab insert_description_here\cr
#' }
"clean.wcann"
...
#' \tabular{rlll}{
#' [,1] \tab ref \tab character \tab survey region\cr
#' [,2] \tab SID \tab integer \tab year of haul\cr
...
#' [,6] \tab vessel \tab character \tab the day and time of the haul\cr
#' [,7] \tab cruise \tab character \tab reference taxonomic ID from raw data\cr
#' [,8] \tab haul \tab character \tab species scientific name; Genus species\cr
#' [,9] \tab CATCHJOIN \tab integer \tab insert_description_here\cr
#' [,10] \tab weight \tab numeric \tab the common name of the organism sampled\cr
#' [,11] \tab cnt \tab numeric \tab the genus of the species\cr
...
#' [,28] \tab station \tab character \tab cruise ID\cr
#' [,29] \tab GEAR_DEPTH \tab integer \tab insert_description_here\cr
#' [,30] \tab depth \tab numeric \tab the integer haul number within a cruise\cr
#' [,31] \tab BOTTOM_TYPE \tab character \tab insert_description_here\cr
#' [,32] \tab stemp \tab numeric \tab a unique identifier for the haul; vessel ID - cruise ID - haul number\cr
#' [,33] \tab btemp \tab numeric \tab the statistical stratum of the haul\cr
#' [,34] \tab WIRE_LENGTH \tab integer \tab insert_description_here\cr
#' [,35] \tab geartype \tab character \tab the station ID for the haul\cr
...
#' [,42] \tab haulid \tab character \tab the dimension of the gear; for trawl net, the width of the mouth in ft\cr
#' [,43] \tab year \tab numeric \tab code for the type of gear used\cr
#' [,44] \tab season \tab character \tab insert_description_here\cr
#' [,45] \tab lat \tab numeric \tab the area of the statistical stratum (km2)\cr
#' [,46] \tab lon \tab numeric \tab latitude of the haul\cr
#' [,47] \tab stratumarea \tab numeric \tab longitude of the haul, in western hemisphere degrees (for lon > 0, do lon-360)\cr
#' [,48] \tab towarea \tab numeric \tab insert_description_here\cr
#' [,49] \tab effort \tab numeric \tab insert_description_here\cr
#' [,50] \tab wtcpue \tab numeric \tab the maximum depth of the water at the location of the haul\cr
#' [,51] \tab cntcpue \tab numeric \tab water temperature at the surface at the location of the haul\cr
#' [,52] \tab reg \tab character \tab water temperature at the bottom at the location of the haul\cr
#' [,53] \tab val.src \tab character \tab insert_description_here\cr
#' [,54] \tab tbl.row \tab integer \tab insert_description_here\cr
#' [,55] \tab mtch.src \tab integer \tab insert_description_here\cr
#' [,56] \tab tax.src \tab character \tab insert_description_here\cr
#' [,57] \tab spp \tab character \tab weight (mass) of the catch\cr
#' [,58] \tab common \tab character \tab number of individuals caught per hectare in the haul\cr
#' [,59] \tab taxLvl \tab character \tab insert_description_here\cr
#' [,60] \tab species \tab character \tab number of individuals in the whole net (may be extrapolated)\cr
#' [,61] \tab genus \tab character \tab the weight (mass) of all items in the net (may be extrapolated)\cr
#' [,62] \tab family \tab character \tab insert_description_here\cr
#' [,63] \tab order \tab character \tab insert_description_here\cr
#' [,64] \tab class \tab character \tab insert_description_here\cr
#' [,65] \tab superclass \tab character \tab insert_description_here\cr
#' [,66] \tab subphylum \tab character \tab insert_description_here\cr
#' [,67] \tab phylum \tab character \tab insert_description_here\cr
#' [,68] \tab kingdom \tab character \tab insert_description_here\cr
#' [,69] \tab trophicDiet \tab character \tab insert_description_here\cr
#' [,70] \tab trophicOrig \tab character \tab insert_description_here\cr
#' [,71] \tab Picture \tab character \tab insert_description_here\cr
#' [,72] \tab trophicLevel \tab numeric \tab insert_description_here\cr
#' [,73] \tab trophicLevel.se \tab numeric \tab insert_description_here\cr
#' [,74] \tab tax.src2 \tab character \tab insert_description_here\cr
#' [,75] \tab conflict \tab logical \tab insert_description_here\cr
#' [,76] \tab flag \tab character \tab insert_description_here\cr
#' [,77] \tab website \tab character \tab insert_description_here\cr
#' [,78] \tab website2 \tab character \tab insert_description_here\cr
#' [,79] \tab keep.row \tab logical \tab insert_description_here\cr
#' }
"clean.wctri"
...
#' \tabular{rlll}{
#' [,1] \tab sppCorr \tab character \tab insert_description_here\cr
#' [,2] \tab taxLvl \tab character \tab insert_description_here\cr
#' [,3] \tab species \tab character \tab the genus of the species\cr
#' [,4] \tab genus \tab character \tab the species name of the species\cr
#' [,5] \tab family \tab character \tab insert_description_here\cr
#' [,6] \tab order \tab character \tab insert_description_here\cr
#' [,7] \tab class \tab character \tab insert_description_here\cr
#' [,8] \tab superclass \tab character \tab insert_description_here\cr
#' [,9] \tab subphylum \tab character \tab insert_description_here\cr
#' [,10] \tab phylum \tab character \tab insert_description_here\cr
#' [,11] \tab kingdom \tab character \tab insert_description_here\cr
#' }
"getTaxData"
...
#' [,4] \tab taxLvl \tab character \tab insert_description_here\cr
#' [,5] \tab species \tab character \tab the genus of the species\cr
#' [,6] \tab genus \tab character \tab the species name of the species\cr
#' [,7] \tab family \tab character \tab insert_description_here\cr
#' [,8] \tab order \tab character \tab insert_description_here\cr
#' [,9] \tab class \tab character \tab insert_description_here\cr
#' [,10] \tab superclass \tab character \tab insert_description_here\cr
#' [,11] \tab subphylum \tab character \tab insert_description_here\cr
#' [,12] \tab phylum \tab character \tab insert_description_here\cr
#' [,13] \tab kingdom \tab character \tab insert_description_here\cr
#' [,14] \tab isSpecies \tab logical \tab insert_description_here\cr
#' [,15] \tab correctSpp \tab logical \tab insert_description_here\cr
#' [,16] \tab trophicDiet \tab character \tab insert_description_here\cr
#' [,17] \tab trophicOrig \tab character \tab insert_description_here\cr
#' [,18] \tab Picture \tab character \tab insert_description_here\cr
#' [,19] \tab trophicLevel \tab numeric \tab insert_description_here\cr
#' [,20] \tab trophicLevel.se \tab numeric \tab insert_description_here\cr
#' }
"taxInfo"
...
#' [,9] \tab species \tab character \tab the genus of the species\cr
#' [,10] \tab genus \tab character \tab the species name of the species\cr
